...
9. Clique com o botão direito no nome do seu projeto no **Gerenciador de Soluções**. No menu de contexto, selecione **Publicar**. Isso abrirá o assistente **Publicar seu suplemento**.
