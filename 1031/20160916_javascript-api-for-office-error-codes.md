...
In diesem Artikel werden die Fehlermeldungen dokumentiert, die bei Verwendung der JavaScript-API für Office (Office.js) auftreten können.
 ...
 _**Gilt für:** Office-Add-Ins | SharePoint-Add-Ins | Excel | Outlook | PowerPoint | Projekt | Word_
...
|**[Error.code](../reference/shared/error.code.md)**|**[Error.name](../reference/shared/error.name.md)**|**[Error.message](../reference/shared/error.message.md)**|**Bedingung**|
|:-----|:-----|:-----|:-----|
